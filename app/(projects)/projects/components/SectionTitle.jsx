...
const SectionTitle = () => (
    ...
    A curated selection of impactful projects demonstrating my skills in{" "}
    <span className="text-primary">full-stack development</span>,{" "}
    <span className="text-primary">machine learning</span>, and{" "}
    <span className="text-primary">DevOps tooling</span>.  
    Each project reflects my focus on clean architecture, problem-solving, and real-world implementation.
</p>
