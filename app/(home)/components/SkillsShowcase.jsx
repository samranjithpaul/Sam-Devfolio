...
const skills = [
    // 1st row — WIDE item (hero skill)
    { name: "JavaScript", icon: <SiJavascript className="w-6 h-6" />, size: "col-span-2 row-span-1" },
    { name: "React.js", icon: <FaReact className="w-6 h-6" />, size: "col-span-1 row-span-1" },
    { name: "Node.js", icon: <FaNodeJs className="w-6 h-6" />, size: "col-span-1 row-span-1" },

    // 2nd row — TALL item (big skill block)
    { name: "MongoDB", icon: <SiMongodb className="w-6 h-6" />, size: "col-span-1 row-span-2" },
    { name: "Express.js", icon: <SiExpress className="w-6 h-6" />, size: "col-span-2 row-span-1" },
    { name: "Git", icon: <FaGithub className="w-6 h-6" />, size: "col-span-1 row-span-1" },

    // 3rd row — small row of 3
    { name: "Python", icon: <HiCode className="w-6 h-6" />, size: "col-span-1 row-span-1" },
    { name: "Docker", icon: <SiDocker className="w-6 h-6" />, size: "col-span-1 row-span-1" },
    { name: "Tailwind", icon: <SiTailwindcss className="w-6 h-6" />, size: "col-span-1 row-span-1" },

    // 4th row — another wide item + 2 normals
    { name: "Figma", icon: <SiFigma className="w-6 h-6" />, size: "col-span-2 row-span-1" },
    { name: "Cursor", icon: <HiCode className="w-6 h-6" />, size: "col-span-1 row-span-1" },
    { name: "Framer Motion", icon: <TbBrandFramerMotion className="w-6 h-6" />, size: "col-span-1 row-span-1" },
];
