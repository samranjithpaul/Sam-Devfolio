...
const Logo = ({ isMobile = false }) => (
    ...
    >
        ...
        >
            ...
            >
                <span className="hidden sm:inline">{config.developer.name} | Devfolio</span>
...
const ContactButton = ({ isMobile = false, onLinkClick }) => (
    <motion.div
        ...
        onClick={onLinkClick}
    >
        <Link href={"https://github.com/samranjithpaul/Sam-Devfolio.git"} target='_blank' className={isMobile ? 'w-full' : ''}>
